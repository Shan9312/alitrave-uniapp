...
var loader = function loader() {__webpack_require__.e(/*! require.ensure | element/loading */ "element/loading").then((function () {return resolve(__webpack_require__(/*! ./element/loading.vue */ 73));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};_vue.default.component('loader', loader); // 引用公共组件- 没数据显示
var nonedata = function nonedata() {__webpack_require__.e(/*! require.ensure | element/none */ "element/none").then((function () {return resolve(__webpack_require__(/*! ./element/none.vue */ 80));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};_vue.default.component('nonedata', nonedata);var homeload = function homeload() {__webpack_require__.e(/*! require.ensure | element/homeload */ "element/homeload").then((function () {return resolve(__webpack_require__(/*! ./element/homeload.vue */ 87));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};_vue.default.component('homeload', homeload); // 引入animate css 动画
